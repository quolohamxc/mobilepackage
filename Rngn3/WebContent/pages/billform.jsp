	...
	<div id="bill">
		<form name="queryForm" method="GET">
			...
			<div id="cunicom" style="display: none">
				<div id="package">
					<p>请选择您现在所使用的套餐：</p>
					<select name="pkg_ucate">
						<option value="1" onclick="showUOption(0)"></option>
						<optgroup label="全国套餐 ">
							<option value="2" onclick="showUOption(1)">3G全国套餐计划</option>
							<option value="3" onclick="showUOption(2)">4G全国套餐</option>
							<option value="4" onclick="showUOption(3)">3G预付费套餐</option>
						</optgroup>
						<optgroup label="组合套餐 ">
							<option value="5" onclick="showUOption(4)">4G全国组合套餐</option>
							<option value="6" onclick="showUOption(5)">4G共享组合套餐</option>
							<option value="7" onclick="showUOption(6)">4G本地组合套餐</option>
						</optgroup>
						<optgroup label="其它">
							<option value="8" onclick="showUOption(0)">其它</option>
						</optgroup>
					</select> <br />
				</div>
