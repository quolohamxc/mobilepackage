...
public class AppPkgInfo implements Serializable {
	...
	public static ArrayList<AppPkgFuel> getAppPkgList() {
		if(appPkgList == null || appPkgList.size() == 0) {
			new AppPkgInfo().addDefaultPkg();
		}
		return appPkgList;
	}

	public static void setAppPkgList(ArrayList<AppPkgFuel> appPkgList) {
		AppPkgInfo.appPkgList = appPkgList;
	}
