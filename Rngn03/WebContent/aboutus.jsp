...
<body>
	<div id="container">
		...
		<div id="header">
			<div id="navcontainer">
				<ul id="menu">
					...
					<li><a href="aboutus.jsp" id="current">关于我们</a></li>
				</ul>
		...
		<div id="content" style="margin-left: 0px; margin-right: 0px;">
			<h1>About Us</h1>
			<p>-铿锵三人行是由来自哈尔滨工业大学计算机科学与技术学院2012级的三名学生组成。
			为了战胜邪恶的随堂作业，我们建立了这个组织，并决定一同完（hu）成（nong）该作业内容。</p>
			<p>-如果你有好的建议或偷懒技巧，欢迎联系我们：</p>
			<p>-<a href="#">mzd44202@126.com</a></p>
		</div>
